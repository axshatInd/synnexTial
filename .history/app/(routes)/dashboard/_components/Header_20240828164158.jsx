...
function Header() {
  ...
  return (
    <header
      ...
      className={`fixed top-4 left-1/2 transform -translate-x-1/2 z-50 flex justify-between items-center px-4 py-2 md:px-6 md:py-3 shadow-2xl rounded-full bg-white w-full max-w-7xl overflow-hidden ${
