...
function Header() {
  ...
  return (
    <header
      ...
      className="fixed top-0 left-0 right-0 z-50 flex justify-between items-center px-6 py-3 md:px-8 md:py-4 shadow-xl rounded-b-lg max-w-8xl mx-auto bg-white"
    >
      <Logo />
