...
// import ThemeSwitcher from "@/app/_components/ThemeSwitcher"; // Removed
...
function Header() {
  ...
  return (
    <header
      ...
      className="fixed top-4 left-1/2 right-1/2 transform -translate-x-1/2 z-50 flex justify-between items-center px-4 py-3 md:px-6 md:py-3 shadow-xl rounded-full bg-white w-full max-w-7xl"
    >
