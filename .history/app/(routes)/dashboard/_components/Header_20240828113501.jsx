...
function Header() {
  ...
  return (
    <header
      ...
      className="fixed top-0 left-0 right-0 z-50 flex justify-between items-center px-4 py-2 md:px-6 md:py-3 lg:py-4 shadow-xl rounded-b-lg max-w-8xl mx-auto bg-white"
    >
      <Logo />
